...
png("annual_avg_T2M.png", 2.5*240, 2.5*240, pointsize = 72)
...
png("annual_avg_RH2M.png", 2.5*240, 2.5*240, pointsize = 72)
par(mar = rep(0.1, 4), oma = rep(1, 4))
...
png("annual_avg_PRECTOTCOR.png", 2.5*240, 2.5*240, pointsize = 72)
par(mar = rep(0.1, 4), oma = rep(1, 4))
...
png("Q_T2M.png", 2.5*480, 2.5*480*(0.8), pointsize = 72)
...
dev.off()
png("Q_RH2M.png", 2.5*480, 2.5*480*(0.8), pointsize = 72)
...
dev.off()
png("Q_PRECTOTCOR.png", 2.5*480, 2.5*480*(0.8), pointsize = 72)
...
png("Anom_T2M.png", 2.5*480, 2.5*480*(0.8), pointsize = 72)
...
dev.off()
png("Anom_RH2M.png", 2.5*480, 2.5*480*(0.8), pointsize = 72)
...
dev.off()
png("Anom_PRECTOTCOR.png", 2.5*480, 2.5*480*(0.8), pointsize = 72)
